  ...
  return (
      ...
      <div className="flex mt-10 j dark:text-white md:mx-20 mx-10 flex-wrap lg:mx-40">
        <div className="lg:w-[60%] w-full">
          ...
          <p className="text-xl text-gray-500 dark:text-gray-400 my-4 lg:my-10">Say Goodbye to 'Not Secure' Warnings Today!!</p>
      ...
      <div>
        <div>
          <h1 className='lg:text-5xl text-3xl text-center font-bold mt-10'>SSL Installation & Configuration
          </h1>
          <p className='text-xl text-gray-500 text-center mt-5'>Secure your website with our comprehensive SSL installation service. We handle everything from setup to ongoing support.</p>
           ...
           <div className='flex flex-wrap mt-14 justify-between  md:mx-20 sm:mx-14 mx-10 lg:mx-40'>
            <div>
              <h1 className='md:text-3xl text-xl font-bold'>Full SSL Installation Package</h1>
        ...
        <div className='flex gap-6 text-xl lg:mx-40 md:mx-20 mx-10 flex-wrap'>
          <div className='flex shadow-md md:p-8 p-3 mt-4 rounded-md gap-5 w-full lg:w-[48%]'>
          ...
          <div className='flex shadow-md md:p-8 p-4 rounded-md gap-5 w-full lg:w-[48%]'>
