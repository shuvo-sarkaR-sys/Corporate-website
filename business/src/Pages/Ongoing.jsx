  ...
  return (
    <div>
       ...
       <div className='mt-10'>
        ...
        <div className='  flex justify-between flex-wrap mx-10 lg:mx-40 shadow-xl rounded-md p-10 mt-10'>
          <div><h1 className='text-center text-3xl font-bold '>Ongoing WordPress Maintenance</h1>
          <p className='text-xl text-gray-500 mb-3'>Starting at <del>$147</del> <strong className='text-black'>${price}.00/month</strong></p>
          <p>Number of sites</p>
          <div className='flex gap-5 my-5'>
            <button className='p-1 px-4 rounded-md text-3xl bg-slate-300' onClick={valueDecrease}>-</button>
            <p className='text-3xl'>{value}</p>
            <button className='p-1 px-4 rounded-md text-3xl bg-slate-300' onClick={valueIncrease}>+</button>
          </div></div>
          <div>
        ...
        <div className='flex flex-wrap mx-10 mt-10 gap-10 lg:mx-40'>
          <div className='shadow-md w-[45%] p-7 rounded-md'>
