...
const Error3 = () => {
  return (
    ...
    <div className='primary-color p-8 flex items-center justify-between rounded-xl'>
      <div>
        <h1 className='md:text-4xl text-2xl font-bold text-white'>403 Error Fix</h1>
        <p className='text-white'>Only $30</p>
      </div>
      <button className='bg-white dark:bg-slate-800 px-7 lg:h-12 text-lg rounded-xl'>Purchase Now</button>
    </div>
    <div className='flex flex-wrap gap-5 mt-10'>
      <div className='bg-slate-300 md:[45%] p-6 rounded-xl dark:bg-slate-800'>
