...
const Wordpress = () => {
  return (
    <div className='dark:text-white'>
      <h1 className='font-bold mt-20 lg:text-5xl text-3xl dark:text-white text-center'>WordPress Site Design &<br /> Development</h1>
      <p className='dark:text-white md:mt-8 mt-4 mb-4 text-center mx-8 md:text-xl'>At 3Zero Digital, we develop WordPress sites with <strong>0 <br />Vulnerability, 0 Downtime,</strong> and <strong>0 Error.</strong> Built for perfection.</p>
      ...
      <form action="submit">
        <div className='flex-col shadow-md p-10 md:mx-14 lg:mx-56'>
          ...
          <input className=' w-full border-2 dark:bg-zinc-800 mb-10 rounded-md p-2 hover:border-purple-800' placeholder='Paste your sample site or design link here' type='word' id="" />
          <p className='text-xl font-bold mb-3'>Your Name</p>
          <input className='dark:bg-zinc-800 w-full border-2 mb-10 rounded-md p-2 hover:border-purple-800' placeholder='Enter your name' type='word' required id="" />
