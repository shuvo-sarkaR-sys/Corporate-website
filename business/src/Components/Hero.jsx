...
const Hero = () => {
  return (
    <div className='lg:flex md:flex-wrap justify-between mt-14 lg:px-40 px-5 md:px-10  mx-auto'>
      <div className=''>
        <h1 className='dark:text-white text-black font-extrabold text-3xl md:text-5xl lg:text-5xl'>3Zero Digital</h1>
