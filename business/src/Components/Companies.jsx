...
const Companies = () => {
  ...
  return (
    <div className='overflow-hidden w-full dark:bg-[#0B1120] relative'>
      <h1 className='textAnimation text-center mb-10 mt-5 font-semibold text-3xl md:text-4xl dark:text-white'>Companies that Trust Us</h1>
      ...
      <h1 className='text-center textAnimation mt-10 font-bold text-3xl md:text-4xl dark:text-white' id='casestudies'>Our Case Studies</h1>
      ...
      {!show ? (<div className='dark:bg-[#111827]   dark:text-white rounded-md shadow-lg flex flex-wrap p-5 md:p-10 md:mx-10 mx-8 lg:mx-40'>
        <div className='div1 relative md:pr-10  lg:w-1/2 w-full md:w-1/2'>
          <div>
        ...
        <div className='div2 md:w-1/2 lg:w-1/2 w-full'>
        ...
        <div className='dark:bg-[#111827]  dark:text-white rounded-md shadow-lg flex gap-10 md:gap-0 lg:gap-0 flex-wrap p-10 md:mx-10 mx-8 lg:mx-40'>
          <div className='div1 relative md:pr-10 lg:w-1/2 w-full md:w-1/2'>
            <div>
          ...
          <div className='div2 md:w-1/2 w-full lg:w-1/2'>
      ...
      <div className='flex div1 justify-center gap-5 mt-12'>
