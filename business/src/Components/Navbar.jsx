...
const Navbar = ({ darkMode, handleClick }) => {
  ...
  return (
    <div >
      ...
      <div className=' dark:text-white z-20 md:mx-10 mx-10 lg:mx-40 font-semibold flex justify-between items-center'>
        <Link to="/"> 
        {/* Navbar image for light mode */}
        <img className='dark:hidden block w-44 my-[-35px]' src={p2} alt="" />
        {/* Navbar image for dark mode */}
        ...
        <ul className='hidden gap-8   lg:flex items-center'>
          <div className='group relative'>
            ...
            <div className='hidden z-10 group-hover:flex   rounded-md p-6  bg-white dark:bg-[#030712] shadow-sm gap-7 absolute  w-[550px]' >

              <div >
                <Link to="wordpress"><div onClick={NavElement} className=' p-2 hover:bg-slate-100 dark:hover:bg-gray-900'>
          ...
          <div className='group relative'>
            ...
            <div className='hidden rounded-md p-4  bg-white dark:bg-[#030712] shadow-sm gap-7 absolute z-10 left-[-160px]  group-hover:flex w-[600px]  '>
              <div>
          ...
          <div className='group relative '>
            ...
            <div className='hidden rounded-md p-4  bg-white dark:bg-[#030712] shadow-sm gap-7 absolute z-10 left-[-300px]  group-hover:flex w-[550px] h-[400px]'>
              <div>
        ...
        <div className='flex gap-4 lg:gap-10'>
          ...
          <Link to='login'><button className='border-2 p-2 rounded-md border-black dark:border-white hidden lg:block'>Get started</button></Link>
          <button onClick={handleNavClick} className='md:block lg:hidden block'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
      ...
      {!showNav ? (<></>) : (<div className='lg:hidden block'>
        <div className=' w-full px-10 absolute z-10  dark:bg-black bg-white dark:text-white font-semibold '>
          ...
          <div className='border-b-2 pb-2 border-black dark:border-white font-semibold '>
            ...
            {!text ? (<></>) : (<div>
              <Link to='wordpress'><div onClick={handleNav} className='flex items-center text-xs gap-2'>
                <img className='h-4 mt-1 w-4' src={word} alt="" />
                <p >WordPress Solutions</p>
              </div></Link>
              <Link to='/next'><div onClick={handleNav} className='flex mt-1 my-2 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={r1} alt="" />
                <p>Headless WordPress & Next.js</p>
              </div></Link>
              <Link to='shopify'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
              ...
              <Link to='/fullstack'><div onClick={handleNav} className='flex mt-1 items-center text-xs my-2 gap-2'>
                <p className='border-2 px-1 rounded-full'>Js</p>
                <p>Fullstack Next.js Applications</p>
              </div></Link>
              <Link to='/mern'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-blue-600 ">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                </svg>            <p>MERN Stack Development</p>
              </div></Link>
              <Link to='/frontend'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
          ...
          <div className='border-b-2 pb-2 border-black dark:border-white font-semibold  '>
            ...
            {!text1 ? (<></>) : (<div>
              <Link to='/malware'><div onClick={handleNav} className='flex items-center text-xs gap-2'>
                <img className='h-4 mt-1 w-4' src={bug} alt="" />
                <p >WordPress Malware Removal</p>
              </div></Link>
              <Link to='speed'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={rocket} alt="" />
                <p>WordPress Speed Optimization</p>
              </div></Link>
              <Link to='security'> <div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={shield} alt="" />

                <p>WordPress Security</p>
              </div></Link>
              <Link to='ongoing'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={shield} alt="" />
                <p>Ongoing WordPress Maintenance</p>
              </div></Link>
              <Link to='blacklist'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={shield} alt="" />
                <p>Blacklist Removal</p>
              </div></Link>
              <Link to='/email deliverability'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
              ...
              <Link to='/website migration'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
                </svg>
                <p>Website Migration</p>
              </div></Link>
              <Link to='ssl'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={shield} alt="" />
          ...
          <div className='border-b-2 border-black dark:border-white pb-2 font-semibold '>
            ...
            {!text2 ? (<></>) : (<div>
              <Link to='/error4'><div onClick={handleNav} className='flex items-center  text-xs gap-2'>
                <img className='h-4 mt-1 w-4' src={error} alt="" />
                <p >404 Page</p>
              </div></Link>
              <Link to='error5'> <div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={error} alt="" />
                <p>500 Page</p>
              </div></Link>
              <Link to='error3'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={error} alt="" />

                <p>403 Forbidden</p>
              </div></Link>
              <Link to='mixed'><div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={error} alt="" />
                <p>Mixed Contect Error</p>
              </div></Link>
              <Link to='/white screen'> <div onClick={handleNav} className='flex mt-1 items-center text-xs gap-2'>
                <img className='h-4 w-4' src={shield} alt="" />
          ...
          <div className='pb-2 font-semibold '>
            <Link to='/' onClick={handleNav}><div className='flex justify-between my-4 text-sm cursor-pointer  ' onClick={handleClick3}> <h1>Case</h1>
