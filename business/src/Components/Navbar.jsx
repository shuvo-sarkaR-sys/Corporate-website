...
<div className='hidden rounded-md p-8  bg-white dark:bg-[#030712] shadow-sm gap-7 absolute left-[-300px]  group-hover:flex w-[550px] h-[400px]'>
 <div>
  <div>
    <h1>404 Page</h1>
...
<div className='group relative'>
                    <li className='flex items-center  gap-1 hover:bg-slate-100 dark:hover:bg-slate-900 cursor-pointer p-1 '><p>Marketing</p><span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 transform transition-transform duration-300 group-hover:rotate-180 ">
  <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
</svg>

</span></li>

<div className='hidden rounded-md p-8  bg-white dark:bg-[#030712] shadow-sm gap-7 absolute left-[-100px] group-hover:flex w-[590px] h-[400px]'>
 <div>
  <div>
    <h1>3D Model</h1>
    <p className='text-gray-500 text-sm'>Create stunning 3D models for your business or projects.</p>
  </div>
  <div className='my-8'>
    <h1>
      3D Animation
    </h1>
    <p className='text-gray-500 text-sm'>Develop captivating 3D animations to promote your products or...</p>
  </div>
  <div className='mb-8'>
    <h1>Backlink Building</h1>
    <p className='text-gray-500 text-sm'>Increate your site's authority through strategic backlink building.</p>
  </div>
  
 </div>
 <div>
  <div>
    <h1>3D Render Image</h1>
    <p className='text-gray-500 text-sm'>
       Generate high-quality 3D render images for visualization and...
    </p>
  </div>
  <div className='my-8'>
    <h1>SEO Optimization</h1>
    <p className='text-gray-500 text-sm'>Optimize your site for search engine visibility.</p>
  </div>
  <div className='my-8'>
    <h1>Social Media Marketing</h1>
    <p className='text-gray-500 text-sm'>Boost your brand's online presence with effective social media...</p>
  </div>
